...
const Description = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row items-center md:items-start ">
      <div className="w-full md:w-2/3 mt-4 p-4 md:p-0">
        <h1 className="font-bold text-2xl text-white">Shikhar Varshney</h1>
        <div className="flex flex-row space-x-2 mt-1 ">
          <span className=" bg-[#d8d8d8] text-xs md:text-sm text-[#09090B] py-0.5 px-2 font-medium rounded-full shadow-lg hover:bg-[#96999E] transition duration-300">
            #openToWork
          </span>
          <span className=" bg-[#d8d8d8] text-xs md:text-sm text-[#09090B] py-0.5 px-2 font-medium rounded-full shadow-lg hover:bg-[#96999E] transition duration-300">
            Hire me!
        ...
        <div className="w-full pr-4">
          <div className="mt-4">
            <h1 className="font-medium text-lg md:text-xl text-white">
              About Me
            </h1>
            <p className="text-sm md:text-base font-normal text-[#9CA3AF] leading-6 mt-1 tracking-wide ">
      ...
      <div className="relative mt-8 md:mt-12 mr-4 flex items-center h-80 w-72 ">
